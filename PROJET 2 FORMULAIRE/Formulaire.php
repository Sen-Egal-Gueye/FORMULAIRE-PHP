...
<body>
    ...
    <center>
            ...
            <legend>CONTACT</legend>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td> <input type="number" name="age" id="age" value="<?php if(isset($_POST['age'])) echo $_POST['age']; ?>"> </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="right"> <button>  <a href="Formulaire.php">Reset</a>  </button>  </td> <br><br>
                    </tr>
        ...
        if (isset($_POST['envoi'])) {
            ...
            /* ----------------------Prenon------------------- /        / -------------------Nom----------------- /         / -------------------Age----------------- /        / -------------------Email------------------- /         / ----------------------Adresse-------------------- */
         if ( isset($_POST['prenom']) && !empty($_POST['prenom'])   &&   isset($_POST['nom']) && !empty($_POST['nom'])   &&    isset($_POST['age']) && !empty($_POST['age'])   &&   isset($_POST['email']) && !empty($_POST['email'])   &&    isset($_POST['adresse']) && !empty($_POST['adresse']) ) {
